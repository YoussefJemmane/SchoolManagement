<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __("Create Un Book dans la Bibliotheque " . $library->type) }}
        </h2>
    </x-slot>

    <div class="flex justify-center py-12 ">
        <div class="border rounded-md bg-white p-[20px]">
            <form method="POST" action="{{ route('book.store',$library->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="author" class="block w-full mt-1" type="text" name="author" :value="old('author')" required autofocus autocomplete="author" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="publisher" class="block w-full mt-1" type="text" name="publisher" :value="old('publisher')" required autofocus autocomplete="publisher" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="isbn" class="block w-full mt-1" type="text" name="isbn" :value="old('isbn')" required autofocus autocomplete="isbn" />
